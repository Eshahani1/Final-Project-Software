...
def get_order_from_tracking_number(tracking_number: int, db: Session = Depends(get_db())):
    return controller.get_order_from_tracking_number(db, tracking_number=tracking_number)
